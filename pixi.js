(function () {
  ...
  (b.WEBGL_RENDERER = 0),
    ...
    (b.scaleModes = { DEFAULT: 0, LINEAR: 0, NEAREST: 1 }),
    (b._UID = 0),
    "undefined" != typeof Float32Array
      ...
      : ((b.Float32Array = Array), (b.Uint16Array = Array)),
    ...
    (b.sayHello = function (a) {
      if (!b.dontSayHello) {
        if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
          ...
          window.console &&
            console.log("Pixi.js " + b.VERSION + " - http://www.pixijs.com/");
        b.dontSayHello = !0;
      }
    }),
    ...
    (b.Polygon.prototype.contains = function (a, b) {
      for (
        var c = !1, d = this.points.length / 2, e = 0, f = d - 1;
        d > e;
        f = e++
      ) {
    ...
    (b.Matrix.prototype.applyInverse = function (a, c) {
      ...
      return (
        (c.x =
          this.d * d * a.x +
          -this.c * d * a.y +
          (this.ty * this.c - this.tx * this.d) * d),
        (c.y =
          this.a * d * a.y +
          -this.b * d * a.x +
          (-this.ty * this.a + this.tx * this.b) * d),
        c
      );
    }),
    ...
    Object.defineProperty(b.DisplayObject.prototype, "cacheAsBitmap", {
      ...
      set: function (a) {
        this._cacheAsBitmap !== a &&
          (a ? this._generateCachedSprite() : this._destroyCachedSprite(),
          (this._cacheAsBitmap = a));
      },
    }),
      ...
      this.rotation % b.PI_2
        ? (this.rotation !== this.rotationCache &&
          ...
          (this.pivot.x || this.pivot.y) &&
            ((f -= this.pivot.x * a + this.pivot.y * d),
    ...
    (b.DisplayObject.prototype.displayObjectUpdateTransform =
      b.DisplayObject.prototype.updateTransform),
    ...
    (b.DisplayObjectContainer.prototype.displayObjectContainerUpdateTransform =
      b.DisplayObjectContainer.prototype.updateTransform),
    ...
    (b.Sprite.prototype._renderWebGL = function (a) {
      if (this.visible && !(this.alpha <= 0)) {
        ...
        if (this._mask || this._filters) {
          ...
          for (
            this._filters &&
              (d.flush(), a.filterManager.pushFilter(this._filterBlock)),
              this._mask &&
                (d.stop(), a.maskManager.pushMask(this.mask, a), d.start()),
              d.render(this),
              b = 0,
              c = this.children.length;
            c > b;
          ...
          for (
            a.spriteBatch.render(this), b = 0, c = this.children.length;
            c > b;
            b++
          )
            this.children[b]._renderWebGL(a);
    ...
    (b.Sprite.prototype._renderCanvas = function (a) {
      if (
        ...
        if (
          (this.blendMode !== a.currentBlendMode &&
            ((a.currentBlendMode = this.blendMode),
            (a.context.globalCompositeOperation =
              b.blendModesCanvas[a.currentBlendMode])),
          this._mask && a.maskManager.pushMask(this._mask, a),
          this.texture.valid)
        ) {
          ...
          (a.context.globalAlpha = this.worldAlpha),
            a.smoothProperty &&
              ...
              ((a.scaleMode = this.texture.baseTexture.scaleMode),
              (a.context[a.smoothProperty] =
                a.scaleMode === b.scaleModes.LINEAR));
          var d = this.texture.trim
          ...
          a.roundPixels
            ? (a.context.setTransform(
                ...
                (this.worldTransform.tx * a.resolution) | 0,
                (this.worldTransform.ty * a.resolution) | 0
              ),
              (d = 0 | d),
              (e = 0 | e))
            : a.context.setTransform(
                ...
                this.worldTransform.c,
                this.worldTransform.d,
                this.worldTransform.tx * a.resolution,
                this.worldTransform.ty * a.resolution
              ),
            16777215 !== this.tint
              ? (this.cachedTint !== this.tint &&
                  ((this.cachedTint = this.tint),
                  (this.tintedTexture = b.CanvasTinter.getTintedTexture(
                    this,
                    this.tint
                  ))),
                a.context.drawImage(
    ...
    (b.SpriteBatch.prototype = Object.create(
    ...
    (b.SpriteBatch.prototype._renderCanvas = function (a) {
      if (this.visible && !(this.alpha <= 0) && this.children.length) {
        ...
        for (
          var c = this.worldTransform, d = !0, e = 0;
            ...
            if (
              ...
              d && (b.setTransform(c.a, c.b, c.c, c.d, c.tx, c.ty), (d = !1)),
                b.drawImage(
                  ...
                  h.width,
                  h.height,
                  (f.anchor.x * -h.width * f.scale.x + f.position.x + 0.5) | 0,
                  (f.anchor.y * -h.height * f.scale.y + f.position.y + 0.5) | 0,
                  h.width * f.scale.x,
                  h.height * f.scale.y
                );
            else {
              ...
              a.roundPixels
                ? b.setTransform(i.a, i.b, i.c, i.d, 0 | i.tx, 0 | i.ty)
                : b.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty),
                b.drawImage(
                  g.baseTexture.source,
                  h.x,
                  h.y,
                  h.width,
                  h.height,
                  (f.anchor.x * -h.width + 0.5) | 0,
                  (f.anchor.y * -h.height + 0.5) | 0,
                  h.width,
                  h.height
                );
            }
        ...
        for (f = 0; f < b.length; f++)
          (k = this.style.strokeThickness / 2),
            ...
            "right" === this.style.align
              ? (k += d - c[f])
              : "center" === this.style.align && (k += (d - c[f]) / 2),
            this.style.fill && this.context.fillText(b[f], k + m, l + n);
      }
      for (this.context.fillStyle = this.style.fill, f = 0; f < b.length; f++)
        (k = this.style.strokeThickness / 2),
          (l = this.style.strokeThickness / 2 + f * i + e.ascent),
          "right" === this.style.align
            ? (k += d - c[f])
          ...
          this.style.stroke &&
            ...
            this.context.strokeText(b[f], k, l),
    ...
    (b.Text.prototype.updateTexture = function () {
      (this.texture.baseTexture.width = this.canvas.width),
        ...
        (this.texture.crop.width = this.texture.frame.width =
          this.canvas.width),
        (this.texture.crop.height = this.texture.frame.height =
          this.canvas.height),
    ...
    (b.Text.fontPropertiesContext =
      b.Text.fontPropertiesCanvas.getContext("2d")),
    ...
    (b.InteractionManager.prototype.collectInteractiveSprite = function (a, b) {
      for (var c = a.children, d = c.length, e = d - 1; e >= 0; e--) {
        var f = c[e];
        f._interactive
          ? ((b.interactiveChildren = !0),
            this.interactiveItems.push(f),
            f.children.length > 0 && this.collectInteractiveSprite(f, f))
          : ((f.__iParent = null),
        ...
        if (((c = (c * b.INTERACTION_FREQUENCY) / 1e3), !(1 > c))) {
          ...
          for (d = 0; e > d; d++) {
            ...
            (h.__hit = this.hitTest(h, this.mouse)),
              (this.mouse.target = h),
              h.__hit && !g
                ? (h.buttonMode && (f = h.defaultCursor),
                  h.interactiveChildren || (g = !0),
                  h.__isOver ||
                    (h.mouseover && h.mouseover(this.mouse), (h.__isOver = !0)))
                : h.__isOver &&
                  (h.mouseout && h.mouseout(this.mouse), (h.__isOver = !1));
          }
          this.currentCursorStyle !== f &&
            ((this.currentCursorStyle = f),
    ...
    (b.InteractionManager.prototype.onMouseMove = function (a) {
      ...
      (this.mouse.global.x =
        ((a.clientX - b.left) * (this.target.width / b.width)) /
        this.resolution),
        (this.mouse.global.y =
          ((a.clientY - b.top) * (this.target.height / b.height)) /
          this.resolution);
    ...
    (b.InteractionManager.prototype.onMouseDown = function (a) {
      ...
      for (
        var c = this.interactiveItems.length,
          d = this.mouse.originalEvent,
          e = 2 === d.button || 3 === d.which,
          f = e ? "rightdown" : "mousedown",
          g = e ? "rightclick" : "click",
          h = e ? "__rightIsDown" : "__mouseIsDown",
          i = e ? "__isRightDown" : "__isDown",
          j = 0;
        c > j;
        j++
      ) {
        ...
        if (
          ...
          k.__hit &&
            (k[f] && k[f](this.mouse), (k[i] = !0), !k.interactiveChildren))
        )
          break;
      }
    }),
    ...
    (b.InteractionManager.prototype.onMouseUp = function (a) {
      ...
      for (
        var b = this.interactiveItems.length,
          ...
          f = e ? "rightup" : "mouseup",
          g = e ? "rightclick" : "click",
          h = e ? "rightupoutside" : "mouseupoutside",
          i = e ? "__isRightDown" : "__isDown",
          j = 0;
        b > j;
        j++
        ...
        (k[g] || k[f] || k[h]) &&
          ...
          k.__hit && !c
            ? (k[f] && k[f](this.mouse),
              ...
              k.interactiveChildren || (c = !0))
            : k[i] && k[h] && k[h](this.mouse),
          (k[i] = !1));
      }
    }),
    (b.InteractionManager.prototype.hitTest = function (a, c) {
      ...
      var e,
        f = this._tempPoint.x,
        g = this._tempPoint.y;
      if (((c.target = a), a.hitArea && a.hitArea.contains))
        return a.hitArea.contains(f, g);
      if (a instanceof b.Sprite) {
        var h,
          i = a.texture.frame.width,
          j = a.texture.frame.height,
          k = -i * a.anchor.x;
        if (f > k && k + i > f && ((h = -j * a.anchor.y), g > h && h + j > g))
          return !0;
    ...
    (b.InteractionManager.prototype.onTouchMove = function (a) {
      this.dirty && this.rebuildInteractiveGraph();
      var b,
        c = this.interactionDOMElement.getBoundingClientRect(),
        d = a.changedTouches,
        e = 0;
      for (e = 0; e < d.length; e++) {
        ...
        (b = this.touches[f.identifier]),
          (b.originalEvent = a),
          (b.global.x =
            ((f.clientX - c.left) * (this.target.width / c.width)) /
            this.resolution),
          (b.global.y =
            ((f.clientY - c.top) * (this.target.height / c.height)) /
            this.resolution),
          !navigator.isCocoonJS ||
            c.left ||
            c.top ||
      ...
      for (var d = a.changedTouches, e = 0; e < d.length; e++) {
        ...
        g || (g = new b.InteractionData()),
          ...
          !navigator.isCocoonJS ||
            ...
            a.target.style.width ||
            a.target.style.height ||
            ((g.global.x = f.clientX), (g.global.y = f.clientY));
        for (var h = this.interactiveItems.length, i = 0; h > i; i++) {
          var j = this.interactiveItems[i];
          if (
            (j.touchstart || j.tap) &&
            ((j.__hit = this.hitTest(j, g)),
            j.__hit &&
              (j.touchstart && j.touchstart(g),
              (j.__isDown = !0),
    ...
    (b.InteractionManager.prototype.onTouchEnd = function (a) {
      ...
      for (
        ...
        var e = c[d],
          ...
          g = !1;
        (f.global.x =
          ((e.clientX - b.left) * (this.target.width / b.width)) /
          this.resolution),
          (f.global.y =
            ((e.clientY - b.top) * (this.target.height / b.height)) /
            this.resolution),
          !navigator.isCocoonJS ||
            b.left ||
            b.top ||
            a.target.style.width ||
            a.target.style.height ||
            ((f.global.x = e.clientX), (f.global.y = e.clientY));
        for (var h = this.interactiveItems.length, i = 0; h > i; i++) {
          var j = this.interactiveItems[i];
          j.__touchData &&
            j.__touchData[e.identifier] &&
            ((j.__hit = this.hitTest(j, j.__touchData[e.identifier])),
            (f.originalEvent = a),
            (j.touchend || j.tap) &&
              (j.__hit && !g
                ? (j.touchend && j.touchend(f),
                  j.__isDown && j.tap && j.tap(f),
                  j.interactiveChildren || (g = !0))
                : j.__isDown && j.touchendoutside && j.touchendoutside(f),
              (j.__isDown = !1)),
        ...
        (a.listeners = function (a) {
          ...
          (a.emit = a.dispatchEvent =
            function (a, c) {
              if (
                ((this._listeners = this._listeners || {}),
                "object" == typeof a && ((c = a), (a = a.type)),
                (c && c.__isEventObject === !0) ||
                  (c = new b.Event(this, a, c)),
                this._listeners && this._listeners[a])
              ) {
                var d,
                  e = this._listeners[a].slice(0),
                  f = e.length,
                  g = e[0];
                for (d = 0; f > d; g = e[++d])
              ...
              return (
                this.parent &&
                  this.parent.emit &&
                  this.parent.emit.call(this.parent, a, c),
                this
              );
            }),
          ...
          (a.off = a.removeEventListener =
            function (a, b) {
              if (
                ((this._listeners = this._listeners || {}), !this._listeners[a])
              )
                return this;
        ...
        if (b.PolyK._convex(l, m, n, o, p, q, c)) {
          ...
          for (var s = 0; h > s; s++) {
            ...
            if (
              ...
              t !== j &&
              t !== k &&
              b.PolyK._PointInTriangle(a[2 * t], a[2 * t + 1], l, m, n, o, p, q)
            ) {
              r = !1;
              break;
            }
    ...
    (b.compileProgram = function (a, c, d) {
      ...
      return (
        ...
        a.attachShader(g, e),
        a.linkProgram(g),
        a.getProgramParameter(g, a.LINK_STATUS) ||
      ...
      for (var c in this.uniforms) {
        ...
        "sampler2D" === d
          ...
          ? ((a.glMatrix = !0),
            (a.glValueLength = 1),
            "mat2" === d
              ? (a.glFunc = b.uniformMatrix2fv)
              : "mat3" === d
              ? (a.glFunc = b.uniformMatrix3fv)
              : "mat4" === d && (a.glFunc = b.uniformMatrix4fv))
          : ((a.glFunc = b["uniform" + d]),
            (a.glValueLength =
              "2f" === d || "2i" === d
                ? 2
                : "3f" === d || "3i" === d
    ...
    (b.PixiShader.prototype.initSampler2D = function (a) {
      if (a.value && a.value.baseTexture && a.value.baseTexture.hasLoaded) {
        ...
        if (
          ...
          if (
            (c.repeat && ((f = b.REPEAT), (g = b.REPEAT)),
            ...
            : "sampler2D" === a.type &&
              (a._init
                ? (c.activeTexture(c["TEXTURE" + this.textureCount]),
                  a.value.baseTexture._dirty[c.id]
                    ? b.instances[c.id].updateTexture(a.value.baseTexture)
                    : c.bindTexture(
                        c.TEXTURE_2D,
                        a.value.baseTexture._glTextures[c.id]
                      ),
    ...
    (b.WebGLGraphics.updateGraphics = function (a, c) {
      var d = a._webGL[c.id];
      d || (d = a._webGL[c.id] = { lastIndex: 0, data: [], gl: c }),
        (a.dirty = !1);
      var e;
      if (a.clearDirty) {
      ...
      for (e = d.lastIndex; e < a.graphicsData.length; e++) {
        ...
        if (h.type === b.Graphics.POLY) {
          if (
            ((h.points = h.shape.points.slice()),
            h.shape.closed &&
              (h.points[0] !== h.points[h.points.length - 2] ||
                h.points[1] !== h.points[h.points.length - 1]) &&
              h.points.push(h.points[0], h.points[1]),
          ...
          (g = b.WebGLGraphics.switchMode(d, 0)),
            h.type === b.Graphics.RECT
              ? b.WebGLGraphics.buildRectangle(h, g)
              : h.type === b.Graphics.CIRC || h.type === b.Graphics.ELIP
              ? b.WebGLGraphics.buildCircle(h, g)
              : h.type === b.Graphics.RREC &&
                b.WebGLGraphics.buildRoundedRectangle(h, g);
        d.lastIndex++;
      }
      for (e = 0; e < d.data.length; e++)
        (g = d.data[e]), g.dirty && g.upload();
    }),
    (b.WebGLGraphics.switchMode = function (a, c) {
      var d;
      return (
        a.data.length
          ? ((d = a.data[a.data.length - 1]),
            (d.mode !== c || 1 === c) &&
              ((d =
                b.WebGLGraphics.graphicsDataPool.pop() ||
                new b.WebGLGraphicsData(a.gl)),
              (d.mode = c),
              a.data.push(d)))
          : ((d =
              b.WebGLGraphics.graphicsDataPool.pop() ||
    ...
    (b.WebGLGraphics.buildRoundedRectangle = function (a, c) {
      ...
      if (
        (j.push(e, f + i),
        (j = j.concat(
          b.WebGLGraphics.quadraticBezierCurve(
            e,
            f + h - i,
            e,
            f + h,
        ...
        (j = j.concat(
          b.WebGLGraphics.quadraticBezierCurve(e + i, f, e, f, e, f + i)
        )),
        a.fill)
      ) {
    ...
    (b.WebGLGraphics.buildCircle = function (a, c) {
      var d,
        ...
        g = f.x,
        h = f.y;
      a.type === b.Graphics.CIRC
        ? ((d = f.radius), (e = f.radius))
    ...
    (b.WebGLGraphics.buildComplexPoly = function (a, c) {
      ...
      if (!(d.length < 6)) {
        ...
        for (
          var f, g, h = 1 / 0, i = -1 / 0, j = 1 / 0, k = -1 / 0, l = 0;
          l < d.length;
          l += 2
        )
          (f = d[l]),
    ...
    (b.WebGLRenderer = function (a, c, d) {
      ...
      b.defaultRenderer || (b.sayHello("webGL"), (b.defaultRenderer = this)),
        ...
        this.view.addEventListener(
          "webglcontextlost",
          this.contextLostBound,
          !1
        ),
        this.view.addEventListener(
          "webglcontextrestored",
          this.contextRestoredBound,
          !1
        ),
    ...
    (b.WebGLRenderer.prototype.render = function (a) {
      if (!this.contextLost) {
        this.__stage !== a &&
          (a.interactive && a.interactionManager.removeEvents(),
          (this.__stage = a)),
          a.updateTransform();
        var b = this.gl;
        a._interactive
    ...
    (b.WebGLRenderer.prototype.mapBlendModes = function () {
      ...
      b.blendModesWebGL ||
        ((b.blendModesWebGL = []),
        (b.blendModesWebGL[b.blendModes.NORMAL] = [
          a.ONE,
    ...
    (b.WebGLStencilManager.prototype.popStencil = function (a, b, c) {
      var d = this.gl;
      if (
        (this.stencilStack.pop(), this.count--, 0 === this.stencilStack.length)
      )
    ...
    (b.WebGLSpriteBatch.prototype.render = function (a) {
      ...
      this.currentBatchSize >= this.size &&
        (this.flush(), (this.currentBaseTexture = b.baseTexture));
      var c = b._uvs;
      if (c) {
        var d,
          e,
    ...
    (b.WebGLSpriteBatch.prototype.renderTilingSprite = function (a) {
      ...
      this.currentBatchSize >= this.size &&
        (this.flush(), (this.currentBaseTexture = c.baseTexture)),
      ...
      var e = a.tilePosition.x / (c.baseTexture.width * a.tileScaleOffset.x),
        ...
        g =
          a.width / c.baseTexture.width / (a.tileScale.x * a.tileScaleOffset.x),
        h =
          a.height /
          c.baseTexture.height /
          (a.tileScale.y * a.tileScaleOffset.y);
      (d.x0 = 0 - e),
        (d.y0 = 0 - f),
        (d.x1 = 1 * g - e),
        (d.y1 = 0 - f),
      ...
      var i = a.tint,
        j =
          (i >> 16) + (65280 & i) + ((255 & i) << 16) + ((255 * a.alpha) << 24),
        k = this.positions,
        l = this.colors,
        m = a.width,
        n = a.height,
        ...
        for (
          ...
          if (
            ...
            (l !== f || o || p) &&
              ...
              (l = f),
              o &&
                ((m = g), this.renderSession.blendModeManager.setBlendMode(m)),
              p))
          ) {
            (n = h),
              (a = n.shaders[c.id]),
              a ||
                ((a = new b.PixiShader(c)),
    ...
    (b.WebGLSpriteBatch.prototype.renderBatch = function (a, b, c) {
      if (0 !== b) {
        var d = this.gl;
        a._dirty[d.id]
          ? this.renderSession.renderer.updateTexture(a)
    ...
    (b.WebGLFastSpriteBatch.prototype.renderSprite = function (a) {
      if (
        a.visible &&
        (a.texture.baseTexture === this.currentBaseTexture ||
          (this.flush(),
    ...
    (b.WebGLFastSpriteBatch.prototype.flush = function () {
      if (0 !== this.currentBatchSize) {
        var a = this.gl;
        if (
          (this.currentBaseTexture._glTextures[a.id] ||
    ...
    (b.WebGLFilterManager.prototype.pushFilter = function (a) {
      ...
      g
        ...
        : (g = new b.FilterTexture(this.gl, this.width, this.height)),
    ...
    (b.WebGLFilterManager.prototype.initShaderBuffers = function () {
      ...
      (this.vertexBuffer = a.createBuffer()),
        ...
        (this.colorArray = new b.Float32Array([
    ...
    (b.FilterTexture = function (a, c, d, e) {
      (this.gl = a),
        ...
        a.texParameteri(
          ...
          e === b.scaleModes.LINEAR ? a.LINEAR : a.NEAREST
        ),
        a.texParameteri(
          a.TEXTURE_2D,
    ...
    (b.CanvasTinter.getTintedTexture = function (a, c) {
      ...
      if (((d.tintCache = d.tintCache || {}), d.tintCache[e]))
        return d.tintCache[e];
      var f = b.CanvasTinter.canvas || document.createElement("canvas");
      if (
        (b.CanvasTinter.tintMethod(d, c, f), b.CanvasTinter.convertTintToImage)
      ) {
        var g = new Image();
    ...
    (b.CanvasTinter.tintWithPerPixel = function (a, c, d) {
      ...
      for (
        var g = b.hex2rgb(c),
          ...
          i = g[1],
          j = g[2],
          k = e.getImageData(0, 0, f.width, f.height),
          l = k.data,
          m = 0;
        m < l.length;
        m += 4
      )
        (l[m + 0] *= h), (l[m + 1] *= i), (l[m + 2] *= j);
    ...
    (b.CanvasTinter.tintMethod = b.CanvasTinter.canUseMultiply
      ? b.CanvasTinter.tintWithMultiply
      : b.CanvasTinter.tintWithPerPixel),
    (b.CanvasRenderer = function (a, c, d) {
      ...
      b.defaultRenderer || (b.sayHello("Canvas"), (b.defaultRenderer = this)),
        ...
        "imageSmoothingEnabled" in this.context
          ...
          : "msImageSmoothingEnabled" in this.context &&
    ...
    (b.CanvasRenderer.prototype.render = function (a) {
      a.updateTransform(),
        ...
        (this.context.globalCompositeOperation =
          b.blendModesCanvas[b.blendModes.NORMAL]),
        navigator.isCocoonJS &&
    ...
    (b.CanvasRenderer.prototype.mapBlendModes = function () {
      b.blendModesCanvas ||
        ...
        b.canUseNewCanvasBlendModes()
          ? ((b.blendModesCanvas[b.blendModes.NORMAL] = "source-over"),
            ...
            (b.blendModesCanvas[b.blendModes.LUMINOSITY] = "luminosity"))
          : ((b.blendModesCanvas[b.blendModes.NORMAL] = "source-over"),
            (b.blendModesCanvas[b.blendModes.ADD] = "lighter"),
        ...
        if (((c.lineWidth = f.lineWidth), f.type === b.Graphics.POLY)) {
          ...
          g.closed && c.lineTo(j[0], j[1]),
            j[0] === j[j.length - 2] &&
              ...
              c.closePath(),
            f.fill &&
              ((c.globalAlpha = f.fillAlpha * d),
              (c.fillStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6)),
              c.fill()),
            f.lineWidth &&
              ((c.globalAlpha = f.lineAlpha * d),
              (c.strokeStyle =
                "#" + ("00000" + (0 | i).toString(16)).substr(-6)),
              c.stroke());
      ...
      if (0 !== d) {
        ...
        for (var e = 0; 1 > e; e++) {
          ...
          if (f.type === b.Graphics.POLY) {
            ...
            c.beginPath(), c.rect(g.x, g.y, g.width, g.height), c.closePath();
          else if (f.type === b.Graphics.CIRC)
            c.beginPath(),
              c.arc(g.x, g.y, g.radius, 0, 2 * Math.PI),
              c.closePath();
      ...
      if (16777215 !== a.tint)
        for (
          ...
          var f = a.graphicsData[e],
            ...
            h = 0 | f.lineColor;
          (f._fillTint =
            (((((g >> 16) & 255) / 255) * b * 255) << 16) +
            (((((g >> 8) & 255) / 255) * c * 255) << 8) +
            ((255 & g) / 255) * d * 255),
            (f._lineTint =
              (((((h >> 16) & 255) / 255) * b * 255) << 16) +
              (((((h >> 8) & 255) / 255) * c * 255) << 8) +
              ((255 & h) / 255) * d * 255);
        }
    }),
    ...
    (b.Graphics.prototype.lineStyle = function (a, c, d) {
      if (
        ...
        if (this.currentPath.shape.points.length)
          return (
            this.drawShape(
              new b.Polygon(this.currentPath.shape.points.slice(-2))
            ),
            this
          );
    ...
    (b.Graphics.prototype.quadraticCurveTo = function (a, b, c, d) {
      ...
      for (
        var i = h[h.length - 2], j = h[h.length - 1], k = 0, l = 1;
        g >= l;
        l++
      )
        (k = l / g),
    ...
    (b.Graphics.prototype.bezierCurveTo = function (a, b, c, d, e, f) {
      ...
      for (
        ...
        (p = q / l),
          ...
          (k = j * p),
          m.push(
            i * n + 3 * h * p * a + 3 * g * j * c + k * e,
            i * o + 3 * h * p * b + 3 * g * j * d + k * f
          );
      return (this.dirty = !0), this;
    }),
      ...
      if (
        (this.currentPath
          ? ((g = this.currentPath.shape.points),
            0 === g.length
              ? g.push(h, i)
              : (g[g.length - 2] !== h || g[g.length - 1] !== i) &&
                g.push(h, i))
          : (this.moveTo(h, i), (g = this.currentPath.shape.points)),
        d === e)
      )
        return this;
      ...
      if (this.graphicsData.length)
        for (var f, g, h, i, j, k, l = 0; l < this.graphicsData.length; l++) {
          var m = this.graphicsData[l],
            n = m.type,
            o = m.lineWidth;
          if (((f = m.shape), n === b.Graphics.RECT || n === b.Graphics.RREC))
            (h = f.x - o / 2),
              (i = f.y - o / 2),
              (j = f.width + o),
              (k = f.height + o),
    ...
    (b.Graphics.prototype._generateCachedSprite = function () {
      ...
      (this._cachedSprite.anchor.x = -(a.x / a.width)),
        ...
        (this.worldAlpha = 1),
        b.CanvasGraphics.renderGraphics(
          this,
    ...
    (b.Graphics.prototype.drawShape = function (a) {
      ...
      return (
        ...
        c.type === b.Graphics.POLY &&
          ((c.shape.closed = this.filling), (this.currentPath = c)),
        (this.dirty = !0),
        c
      );
    }),
      ...
      a.blendModeManager.setBlendMode(this.blendMode),
        ...
        this.dirty
          ? ((this.dirty = !1),
            ...
            c.activeTexture(c.TEXTURE0),
            this.texture.baseTexture._dirty[c.id]
              ? a.renderer.updateTexture(this.texture.baseTexture)
              : c.bindTexture(
                  c.TEXTURE_2D,
                  this.texture.baseTexture._glTextures[c.id]
                ),
    ...
    (b.Strip.prototype._renderCanvas = function (a) {
      var c = a.context,
        d = this.worldTransform;
      a.roundPixels
        ? c.setTransform(d.a, d.b, d.c, d.d, 0 | d.tx, 0 | d.ty)
        : c.setTransform(d.a, d.b, d.c, d.d, d.tx, d.ty),
        this.drawMode === b.Strip.DrawModes.TRIANGLE_STRIP
    ...
    (b.Strip.prototype._renderCanvasDrawTriangle = function (a, b, c, d, e, f) {
      ...
      var C = p * t + s * r + q * u - t * r - s * q - p * u,
        ...
        F =
          p * t * l + s * k * r + j * q * u - j * t * r - s * q * l - p * k * u,
        G = m * t + s * o + n * u - t * o - s * n - m * u,
        H = p * n + m * r + q * o - n * r - m * q - p * o,
        I =
          p * t * o + s * n * r + m * q * u - m * t * r - s * q * o - p * n * u;
    ...
    (b.Rope.prototype.updateTransform = function () {
      ...
      if (!(a.length < 1)) {
        ...
        this.count -= 0.2;
        for (
          var f, g, h, i, j, k = this.vertices, l = a.length, m = 0;
          l > m;
          m++
        )
          (f = a[m]),
    ...
    (b.TilingSprite.prototype._renderCanvas = function (a) {
      if (this.visible !== !1 && 0 !== this.alpha) {
        ...
        if (
          ...
          this.__tilePattern = c.createPattern(
        ...
        for (
          h.x %= this.tilingTexture.baseTexture.width,
            ...
            c.scale(i.x, i.y),
            c.translate(
              h.x + this.anchor.x * -this._width,
              h.y + this.anchor.y * -this._height
            ),
  ...
  (c.BoneData = function (a, b) {
    ...
    (c.IkConstraintData.prototype = { target: null, bendDirection: 1, mix: 1 }),
    ...
    (c.Bone.prototype = {
      ...
      updateWorldTransform: function () {
        ...
        if (a)
          (this.worldX = this.x * a.m00 + this.y * a.m01 + a.worldX),
            ...
            this.data.inheritScale
              ? ((this.worldScaleX = a.worldScaleX * this.scaleX),
                (this.worldScaleY = a.worldScaleY * this.scaleY))
              : ((this.worldScaleX = this.scaleX),
                (this.worldScaleY = this.scaleY)),
            (this.worldRotation = this.data.inheritRotation
              ? a.worldRotation + this.rotationIK
              : this.rotationIK),
        ...
        var e = this.worldRotation * c.degRad,
          ...
          g = Math.sin(e);
        this.worldFlipX
          ? ((this.m00 = -f * this.worldScaleX),
            (this.m01 = g * this.worldScaleY))
          : ((this.m00 = f * this.worldScaleX),
            (this.m01 = -g * this.worldScaleY)),
          this.worldFlipY != c.Bone.yDown
      ...
      worldToLocal: function (a) {
        var b = a[0] - this.worldX,
          ...
          g = this.m01,
          h = this.m11;
        this.worldFlipX != (this.worldFlipY != c.Bone.yDown) &&
          ((e = -e), (h = -h));
        var i = 1 / (e * h - g * f);
    ...
    (c.Slot.prototype = {
      ...
      setToSetupPose: function () {
        ...
        for (
          var b = this.bone.skeleton.data.slots, c = 0, d = b.length;
          d > c;
          c++
        )
          if (b[c] == a) {
    ...
    (c.IkConstraint.apply2 = function (a, b, d, e, f, g) {
      ...
      var n = j * a.worldScaleX,
        ...
        s = 2 * q * r;
      if (1e-4 > s)
        return void (b.rotationIK =
          h + (Math.atan2(e, d) * c.radDeg - i - h) * g);
    ...
    (c.RotateTimeline.prototype = {
      ...
      apply: function (a, b, d, e, f) {
        ...
        if (!(d < g[0])) {
          ...
          if (d >= g[g.length - 2]) {
            for (
              var i = h.data.rotation + g[g.length - 1] - h.rotation;
              i > 180;
    ...
    (c.TranslateTimeline.prototype = {
      ...
      apply: function (a, b, d, e, f) {
        ...
        if (!(d < g[0])) {
          ...
          if (d >= g[g.length - 3])
            return (
              (h.x += (h.data.x + g[g.length - 2] - h.x) * f),
    ...
    (c.ScaleTimeline.prototype = {
      ...
      apply: function (a, b, d, e, f) {
        ...
        if (!(d < g[0])) {
          ...
          if (d >= g[g.length - 3])
            return (
              (h.scaleX += (h.data.scaleX * g[g.length - 2] - h.scaleX) * f),
              void (h.scaleY +=
                (h.data.scaleY * g[g.length - 1] - h.scaleY) * f)
            );
          var i = c.Animation.binarySearch(g, d, 3),
            j = g[i - 2],
            k = g[i - 1],
          ...
          (m = this.curves.getCurvePercent(i / 3 - 1, m)),
            (h.scaleX +=
              (h.data.scaleX * (j + (g[i + 1] - j) * m) - h.scaleX) * f),
            (h.scaleY +=
              (h.data.scaleY * (k + (g[i + 2] - k) * m) - h.scaleY) * f);
        }
      },
    }),
    ...
    (c.AttachmentTimeline.prototype = {
      ...
      apply: function (a, b, d) {
        ...
        var f =
          d >= e[e.length - 1]
            ? e.length - 1
            : c.Animation.binarySearch1(e, d) - 1;
        if (!(e[f] < b)) {
          var g = this.attachmentNames[f];
          a.slots[this.slotIndex].setAttachment(
            g ? a.getAttachmentBySlotIndex(this.slotIndex, g) : null
          );
        }
      },
    }),
      ...
      apply: function (a, b, d) {
        ...
        if (!(d < e[0])) {
          ...
          var g = a.drawOrder,
            h = a.slots,
            i = this.drawOrders[f];
          if (i) for (var j = 0, k = i.length; k > j; j++) g[j] = a.slots[i[j]];
          else for (var j = 0, k = h.length; k > j; j++) g[j] = h[j];
        }
      },
    }),
      ...
      apply: function (a, b, d, e, f) {
        ...
        if (g.attachment == this.attachment) {
          ...
          if (!(d < h[0])) {
            ...
            if (
              (k.length != j && (f = 1), (k.length = j), d >= h[h.length - 1])
            ) {
              var l = i[h.length - 1];
    ...
    (c.FlipXTimeline.prototype = {
      ...
      apply: function (a, b, d) {
        ...
        var f =
          (d >= e[e.length - 2]
            ? e.length
            : c.Animation.binarySearch(e, d, 2)) - 2;
    ...
    (c.Skeleton.prototype = {
      ...
      updateCache: function () {
        ...
        a: for (var e = 0, f = h.length; f > e; e++) {
          ...
          do {
            for (var k = 0; b > k; k++)
              for (
                var l = a[k], m = l.bones[0], n = l.bones[l.bones.length - 1];
                ;
      ...
      setSlotsToSetupPose: function () {
        for (
          var a = this.slots, b = this.drawOrder, c = 0, d = a.length;
          d > c;
          c++
        )
          (b[c] = a[c]), a[c].setToSetupPose(c);
      },
      ...
      setAttachment: function (a, b) {
        for (var c = this.slots, d = 0, e = c.length; e > d; d++) {
          ...
          if (f.data.name == a) {
            var g = null;
            if (b && ((g = this.getAttachmentBySlotIndex(d, b)), !g))
    ...
    (c.EventData.prototype = { intValue: 0, floatValue: 0, stringValue: null }),
    (c.Event = function (a) {
      this.data = a;
    }),
    (c.Event.prototype = { intValue: 0, floatValue: 0, stringValue: null }),
    (c.AttachmentType = { region: 0, boundingbox: 1, mesh: 2, skinnedmesh: 3 }),
    ...
    (c.MeshAttachment.prototype = {
      ...
      updateUVs: function () {
        ...
        if (
          ((this.uvs && this.uvs.length == d) ||
            (this.uvs = new c.Float32Array(d)),
          this.regionRotate)
        )
          for (var e = 0; d > e; e += 2)
      ...
      computeWorldVertices: function (a, b, c, d) {
        ...
        if (c.attachmentVertices.length)
          for (var t = c.attachmentVertices; s > p; o += 2) {
            for (f = 0, g = 0, e = n[p++] + p; e > p; p++, q += 3, r += 2)
              (h = l[n[p]]),
                (i = m[q] + t[r]),
                (j = m[q + 1] + t[r + 1]),
                (k = m[q + 2]),
    ...
    (c.AnimationStateData.prototype = {
      ...
      getMix: function (a, b) {
        var c = a.name + ":" + b.name;
        return this.animationToMixTime.hasOwnProperty(c)
          ? this.animationToMixTime[c]
          : this.defaultMix;
      },
    }),
    ...
    (c.AnimationState.prototype = {
      ...
      update: function (a) {
        ...
        for (var b = 0; b < this.tracks.length; b++) {
          ...
          if (c) {
            ...
            var e = c.next;
            e
              ? ((e.time = c.lastTime - e.delay),
                e.time >= 0 && this.setCurrent(b, e))
              : !c.loop && c.lastTime >= c.endTime && this.clearTrack(b);
          }
        }
      },
      apply: function (a) {
        for (var b = 0; b < this.tracks.length; b++) {
          ...
          if (c) {
            ...
            if (h) {
              ...
              1 == c.mix
                ? c.animation.apply(a, c.lastTime, d, g, this.events)
                : c.animation.mix(a, c.lastTime, d, g, this.events, c.mix);
      ...
      setCurrent: function (a, b) {
        ...
        if (c) {
          ...
          (c.previous = null),
            ...
            b.mixDuration > 0 &&
              ((b.mixTime = 0),
              (b.previous = d && c.mixTime / c.mixDuration < 0.5 ? d : c));
        }
        (this.tracks[a] = b),
      ...
      addAnimation: function (a, b, d, e) {
        ...
        return (
          0 >= e &&
            (g ? (e += g.endTime - this.data.getMix(g.animation, b)) : (e = 0)),
          (f.delay = e),
          f
        );
      },
    ...
    (c.SkeletonJson.prototype = {
      ...
      readSkeletonData: function (a, b) {
        ...
        for (var f = a.bones, g = 0, h = f.length; h > g; g++) {
          var i = f[g],
            j = null;
          if (i.parent && ((j = d.findBone(i.parent)), !j))
          ...
          (k.length = (i.length || 0) * this.scale),
            ...
            (k.inheritScale = i.hasOwnProperty("inheritScale")
              ? i.inheritScale
              : !0),
            (k.inheritRotation = i.hasOwnProperty("inheritRotation")
              ? i.inheritRotation
              : !0),
            d.bones.push(k);
        }
        ...
        if (l)
          for (var g = 0, h = l.length; h > g; g++) {
            for (
              var m = l[g],
                n = new c.IkConstraintData(m.name),
                f = m.bones,
                o = 0,
                p = f.length;
              p > o;
            ...
            if (((n.target = d.findBone(m.target)), !n.target))
              throw "Target bone not found: " + m.target;
            (n.bendDirection =
              !m.hasOwnProperty("bendPositive") || m.bendPositive ? 1 : -1),
      ...
      readAttachment: function (a, b, d) {
        ...
        if (e == c.AttachmentType.skinnedmesh) {
          ...
          j.path = f;
          for (
            var k = this.getFloatArray(d, "uvs", 1),
              l = this.getFloatArray(d, "vertices", 1),
              m = [],
              n = [],
              o = 0,
              p = l.length;
        ...
        if (e == c.AttachmentType.boundingbox) {
          for (
            var s = this.attachmentLoader.newBoundingBoxAttachment(a, b),
              l = d.vertices,
              o = 0,
              p = l.length;
            p > o;
      ...
      readAnimation: function (a, b, d) {
            ...
            for (var k in i)
              if (i.hasOwnProperty(k)) {
                ...
                if ("color" == k) {
                  ...
                  if ("attachment" != k)
                    throw (
                      "Invalid timeline type for a slot: " + k + " (" + h + ")"
                    );
              ...
              if (z.hasOwnProperty(k)) {
                ...
                if ("rotate" == k) {
                  ...
                  var m,
                    A = 1;
                  "scale" == k
                    ? (m = new c.ScaleTimeline(l.length))
                    : ((m = new c.TranslateTimeline(l.length)),
                      (A = this.scale)),
                    (m.boneIndex = y);
                  for (var n = 0, o = 0, p = l.length; p > o; o++) {
                    var q = l[o],
                  ...
                  if ("flipX" != k && "flipY" != k)
                    throw (
                      "Invalid timeline type for a bone: " + k + " (" + x + ")"
                    );
                  var B = "flipX" == k,
                    m = B
                      ? new c.FlipXTimeline(l.length)
                      : new c.FlipYTimeline(l.length);
                  m.boneIndex = y;
                  for (
                    var D = B ? "x" : "y", n = 0, o = 0, p = l.length;
                    p > o;
                    o++
                  ) {
                    var q = l[o];
          ...
          if (E.hasOwnProperty(F)) {
            ...
            for (var n = 0, o = 0, p = l.length; p > o; o++) {
              var q = l[o],
                ...
                I =
                  !q.hasOwnProperty("bendPositive") || q.bendPositive ? 1 : -1;
        ...
        for (var K in J) {
          ...
          for (h in i) {
            ...
            for (var N in M) {
              ...
              var P,
                Q = O.type == c.AttachmentType.mesh;
        ...
        if ((X || (X = b.draworder), X)) {
          for (
            var m = new c.DrawOrderTimeline(X.length),
              Y = d.slots.length,
              n = 0,
              o = 0,
              p = X.length;
        ...
        if (eb) {
          for (
            var m = new c.EventTimeline(eb.length), n = 0, o = 0, p = eb.length;
            p > o;
            o++
          ) {
            var fb = eb[o],
            ...
            (hb.intValue = fb.hasOwnProperty("int") ? fb["int"] : gb.intValue),
              (hb.floatValue = fb.hasOwnProperty("float")
                ? fb["float"]
                : gb.floatValue),
              (hb.stringValue = fb.hasOwnProperty("string")
                ? fb.string
                : gb.stringValue),
              m.setFrame(n++, fb.time, hb);
          }
          e.push(m), (f = Math.max(f, m.frames[m.getFrameCount() - 1]));
        }
      ...
      readCurve: function (a, b, c) {
        ...
        d
          ? "stepped" == d
            ? a.curves.setStepped(b)
            : d instanceof Array && a.curves.setCurve(b, d[0], d[1], d[2], d[3])
          : a.curves.setLinear(b);
      },
      ...
      getIntArray: function (a, b) {
        for (
          var d = a[b], e = new c.Uint16Array(d.length), f = 0, g = d.length;
          g > f;
          f++
        )
          e[f] = 0 | d[f];
        ...
        if (((g = d.trim(g)), g.length))
          if (f) {
            ...
            (h.u = i / f.width),
              (h.v = j / f.height),
              h.rotate
                ? ((h.u2 = (i + l) / f.width), (h.v2 = (j + k) / f.height))
                : ((h.u2 = (i + k) / f.width), (h.v2 = (j + l) / f.height)),
              (h.x = i),
              (h.y = j),
              (h.width = Math.abs(k)),
              (h.height = Math.abs(l)),
            ...
            (f.uWrap = c.Atlas.TextureWrap.clampToEdge),
              ...
              "x" == m
                ? (f.uWrap = c.Atlas.TextureWrap.repeat)
                : "y" == m
                ? (f.vWrap = c.Atlas.TextureWrap.repeat)
                : "xy" == m && (f.uWrap = f.vWrap = c.Atlas.TextureWrap.repeat),
              b.load(f, g, this),
              this.pages.push(f);
          }
        else f = null;
      ...
      updateUVs: function (a) {
        for (var b = this.regions, c = 0, d = b.length; d > c; c++) {
          ...
          e.page == a &&
            ...
            (e.v = e.y / a.height),
            e.rotate
              ? ((e.u2 = (e.x + e.height) / a.width),
                (e.v2 = (e.y + e.width) / a.height))
              : ((e.u2 = (e.x + e.width) / a.width),
    ...
    (c.Atlas.TextureWrap = { mirroredRepeat: 0, clampToEdge: 1, repeat: 2 }),
    ...
    (c.AtlasAttachmentLoader.prototype = {
      ...
      newMeshAttachment: function (a, b, d) {
        ...
        if (!e)
          throw (
            "Region not found in atlas: " + d + " (mesh attachment: " + b + ")"
          );
    ...
    (b.SpineTextureLoader.prototype.load = function (a, c) {
      if (
        ((a.rendererObject = b.BaseTexture.fromImage(
          this.basePath + "/" + c,
          this.crossorigin
        )),
        ...
        ++d.loadingCount,
          a.rendererObject.addEventListener("loaded", function () {
            --d.loadingCount,
              d.dispatchEvent({ type: "loadedBaseTexture", content: d });
          });
      }
    }),
    ...
    Object.defineProperty(b.Spine.prototype, "autoUpdate", {
      ...
      set: function (a) {
        this.updateTransform = a
          ? b.Spine.prototype.autoUpdateTransform
          : b.DisplayObjectContainer.prototype.updateTransform;
      },
    }),
      ...
      for (var d = this.skeleton.drawOrder, e = 0, f = d.length; f > e; e++) {
        ...
        if (h) {
          ...
          if (j === c.AttachmentType.region) {
            if (
              h.rendererObject &&
              (!g.currentSpriteName || g.currentSpriteName !== h.name)
            ) {
              var k = h.rendererObject.name;
              if (
                (void 0 !== g.currentSprite && (g.currentSprite.visible = !1),
                (g.sprites = g.sprites || {}),
                void 0 !== g.sprites[k])
              )
            ...
            if (!g.currentMeshName || g.currentMeshName !== h.name) {
              var n = h.name;
              if (
                (void 0 !== g.currentMesh && (g.currentMesh.visible = !1),
                (g.meshes = g.meshes || {}),
                void 0 !== g.meshes[n])
              )
            ...
            h.computeWorldVertices(
              g.bone.skeleton.x,
              g.bone.skeleton.y,
              g,
              g.currentMesh.vertices
            );
          }
    ...
    (b.Spine.prototype.createSprite = function (a, d) {
      var e = d.rendererObject,
        ...
        g = new b.Rectangle(
          e.x,
          e.y,
          e.rotate ? e.height : e.width,
          e.rotate ? e.width : e.height
        ),
        h = new b.Texture(f, g),
        i = new b.Sprite(h),
        j = e.rotate ? 0.5 * Math.PI : 0;
      return (
        i.scale.set(e.width / e.originalWidth, e.height / e.originalHeight),
    ...
    (b.Spine.prototype.createMesh = function (a, c) {
      var d = c.rendererObject,
        ...
        g = new b.Strip(f);
      return (
        (g.drawMode = b.Strip.DrawModes.TRIANGLES),
        (g.canvasPadding = 1.5),
    ...
    (b.BaseTexture.fromCanvas = function (a, c) {
      ...
      return (
        d ||
          ((d = new b.BaseTexture(a, c)), (b.BaseTextureCache[a._pixiId] = d)),
        d
      );
    }),
    (b.TextureCache = {}),
      ...
      (this.noFrame = !1),
        ...
        a.hasLoaded
          ? (this.noFrame && (c = new b.Rectangle(0, 0, a.width, a.height)),
            this.setFrame(c))
          : a.addEventListener("loaded", this.onBaseTextureLoaded.bind(this));
    }),
    ...
    (b.Texture.fromFrame = function (a) {
      ...
      if (!c)
        throw new Error(
          'The frameId "' + a + '" does not exist in the texture cache '
        );
      return c;
    }),
    ...
    (b.RenderTexture = function (a, c, d, e, f) {
      if (
        ...
        (this.height = c || 100),
        (this.resolution = f || 1),
        (this.frame = new b.Rectangle(
          0,
          0,
          this.width * this.resolution,
          this.height * this.resolution
        )),
        (this.crop = new b.Rectangle(
          0,
          0,
          this.width * this.resolution,
          this.height * this.resolution
        ...
        b.Texture.call(
          this,
          this.baseTexture,
          new b.Rectangle(0, 0, this.width, this.height)
        ),
        ...
        (this.baseTexture._dirty[g.id] = !1),
          (this.textureBuffer = new b.FilterTexture(
            g,
            this.width * this.resolution,
            this.height * this.resolution,
        ...
        (this.render = this.renderCanvas),
          (this.textureBuffer = new b.CanvasBuffer(
            this.width * this.resolution,
            this.height * this.resolution
          )),
    ...
    (b.VideoTexture = function (a, c) {
      ...
      (a.readyState === a.HAVE_ENOUGH_DATA ||
        a.readyState === a.HAVE_FUTURE_DATA) &&
        a.width &&
        a.height &&
        (a.complete = !0),
    ...
    (b.VideoTexture.prototype._onUpdate = function () {
      this.autoUpdate &&
        (window.requestAnimationFrame(this.updateBound), this.dirty());
    }),
    ...
    (b.VideoTexture.prototype.destroy = function () {
      this.source &&
        this.source._pixiId &&
        ((b.BaseTextureCache[this.source._pixiId] = null),
        delete b.BaseTextureCache[this.source._pixiId],
    ...
    (b.VideoTexture.baseTextureFromVideo = function (a, c) {
      ...
      return (
        d ||
          ((d = new b.VideoTexture(a, c)), (b.BaseTextureCache[a._pixiId] = d)),
        d
      );
    }),
    ...
    (b.AssetLoader.prototype._getDataType = function (a) {
      ...
      if (c === b) {
        ...
        return f && "text/plain" !== f.toLowerCase()
      ...
      window.XDomainRequest && this.crossorigin
        ...
        : ((this.ajaxRequest = window.XMLHttpRequest
          ...
          (this.ajaxRequest.onreadystatechange =
            this.onReadyStateChanged.bind(this))),
      ...
      if (
        ...
        if (b.AnimCache[this.url]) this.onLoaded();
          ...
          (n.onJSONLoaded = function () {
            if (!this.ajaxRequest.responseText) return void this.onError();
            var a = new b.SpineTextureLoader(
            ...
            (b.AnimCache[o.url] = g),
              ...
              a.loadingCount > 0
                ? a.addEventListener("loadedBaseTexture", function (a) {
      ...
      if (4 === this.ajaxRequest.readyState)
        if (
              ...
              if (f === g)
                ...
                if (c % 7 === 1)
                  ...
                  if (c % 7 === 3)
                    ...
                    k.w > e.frame.w || k.h > e.frame.h
                      ? ((e.trimmed = !0), (e.realSize = k))
                      : (e.trimmed = !1);
                  }
                }
              c++;
          ...
          if (
            ...
            for (
              this.images = [], h = 0;
              h < this.atlas.meta.image.length;
              h++
            ) {
              ...
              for (g in m) {
                var n = m[g].frame;
                n &&
                  ((b.TextureCache[g] = new b.Texture(
                    this.images[h].texture.baseTexture,
                    { x: n.x, y: n.y, width: n.w, height: n.h }
                  )),
                  m[g].trimmed &&
                    ((b.TextureCache[g].realSize = m[g].realSize),
                    (b.TextureCache[g].trim.x = 0),
                    (b.TextureCache[g].trim.y = 0)));
              }
            }
            for (this.currentImageId = 0, h = 0; h < this.images.length; h++)
    ...
    (b.ImageLoader.prototype.loadFramedSpriteSheet = function (a, c, d) {
      this.frames = [];
      for (
        var e = Math.floor(this.texture.width / a),
          f = Math.floor(this.texture.height / c),
          g = 0,
          h = 0;
        f > h;
        h++
    ...
    (b.BitmapFontLoader.prototype.onXMLLoaded = function () {
      if (
        ...
        var e =
            this.baseUrl +
            a.getElementsByTagName("page")[0].getAttribute("file"),
        ...
        for (var j = a.getElementsByTagName("char"), k = 0; k < j.length; k++) {
          var l = parseInt(j[k].getAttribute("id"), 10),
            m = new b.Rectangle(
              parseInt(j[k].getAttribute("x"), 10),
              parseInt(j[k].getAttribute("y"), 10),
              parseInt(j[k].getAttribute("width"), 10),
              parseInt(j[k].getAttribute("height"), 10)
            );
          g.chars[l] = {
    ...
    (b.AlphaMaskFilter = function (a) {
      b.AbstractFilter.call(this),
        ...
        (this.uniforms = {
          mask: { type: "sampler2D", value: a },
          mapDimensions: { type: "2f", value: { x: 1, y: 5112 } },
          dimensions: { type: "4fv", value: [0, 0, 0, 0] },
        }),
        a.baseTexture.hasLoaded
          ? ((this.uniforms.mask.value.x = a.width),
            (this.uniforms.mask.value.y = a.height))
    ...
    (b.DisplacementFilter = function (a) {
      b.AbstractFilter.call(this),
        ...
        (a.baseTexture._powerOf2 = !0),
        (this.uniforms = {
          displacementMap: { type: "sampler2D", value: a },
        ...
        a.baseTexture.hasLoaded
          ? ((this.uniforms.mapDimensions.value.x = a.width),
            (this.uniforms.mapDimensions.value.y = a.height))
          : ((this.boundLoadedFunction = this.onTextureLoaded.bind(this)),
            a.baseTexture.on("loaded", this.boundLoadedFunction)),
        (this.fragmentSrc = [
          "precision mediump float;",
    ...
    (b.DisplacementFilter.prototype = Object.create(
      b.AbstractFilter.prototype
    )),
